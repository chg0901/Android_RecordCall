...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = (TextView) findViewById(R.id.employTxt);
        layoutManager = new LinearLayoutManager(this);//
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        /**
         * RecyclerView can perform several optimizations
         * if it can know in advance that RecyclerView's size is not affected
         * by the adapter contents.
         */
    ...
    /**
     * read data from the database(SQLite)
     */
